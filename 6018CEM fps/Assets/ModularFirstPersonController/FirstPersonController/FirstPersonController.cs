...
public class FirstPersonController : MonoBehaviour
{
    ...
    public void Chat()
    {
        chatText.text = myInputField.text;
        myInputField.text = "";
        PlayerPrefs.Save();
        PlayerPrefs.SetString("", chatText.text);
...
// Custom Editor
    ...
    //    fpc.myInputField = (InputField)EditorGUILayout.ObjectField(new GUIContent("Chat box", "Camera attached to the controller."), fpc.myInputField, typeof(InputField), true);
    //    //fpc.chatText = (string)EditorGUILayout.TextArea(new GUIContent("Chat box", "Camera attached to the controller."), fpc.myInputField, typeof(string), true);
